 import 'package:flutter/material.dart';
        ...
        // Figma Flutter Generator TagWidget - FRAME
      ...
      border : Border.all(
        ...
        top: 151,
        left: 48,
        child: Text('#Newy', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(124, 124, 124, 1),
        fontFamily: 'Poppins',
        fontSize: 14,
        letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
        ...
        top: 255,
        left: 36,
        child: Text('Add New Tag…', textAlign: TextAlign.left, style: TextStyle(
        ...
        top: 792,
        left: 48,
        child: Text('The unselected will searched
And deleted if there is no mail 
Has the tag', textAlign: TextAlign.left, style: TextStyle(
        color: Color.fromRGBO(253, 149, 149, 1),
        fontFamily: 'Poppins',
        fontSize: 22,
        letterSpacing: 0,
        fontWeight: FontWeight.normal,
